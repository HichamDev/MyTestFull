trigger CatalogBeforeUpdate on CAT_Catalog__c (before update) {
/*
// CatalogBeforeUpdate
----------------------------------------------------------------------
...
**********************************************************************
*/
	system.debug('## START Trigger CatalogBeforeUpdate <<<<<'+UserInfo.getUserName());
	...
	system.debug('## END Trigger CatalogBeforeUpdate <<<<<'+UserInfo.getUserName());
}
trigger KitBeforeInsert on KIT_Kit__c (before insert) {
/*
// KitBeforeInsert
----------------------------------------------------------------------
-- - Name          : KitBeforeInsert
...
**********************************************************************
*/
	system.debug('## START Trigger KitBeforeInsert <<<<<'+UserInfo.getUserName());
	...
	system.debug('## END Trigger KitBeforeInsert <<<<<'+UserInfo.getUserName());
}
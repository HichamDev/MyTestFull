trigger ArticleBeforeUpdate on ART_Article__c (before update) {
/*
// ArticleBeforeUpdate
----------------------------------------------------------------------
-- - Name          : ArticleBeforeUpdate
...
**********************************************************************
*/
	system.debug('## START Trigger ArticleBeforeUpdate <<<<<'+UserInfo.getUserName());
	...
	system.debug('## END Trigger ArticleBeforeUpdate <<<<<'+UserInfo.getUserName());
}
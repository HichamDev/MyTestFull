trigger InvoiceBeforeInsert on INV_Invoice__c (before insert) {
/*
// InvoiceBeforeInsert
----------------------------------------------------------------------
...
**********************************************************************
*/
	system.debug('## START Trigger InvoiceBeforeInsert <<<<<'+UserInfo.getUserName());
	...
	system.debug('## END Trigger InvoiceBeforeInsert <<<<<'+UserInfo.getUserName());
